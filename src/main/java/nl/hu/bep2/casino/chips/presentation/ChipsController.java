...
public class ChipsController {
    ...
    public void withdrawal(Authentication authentication, @RequestBody Withdrawal withdrawal) {
        UserProfile profile = (UserProfile) authentication.getPrincipal();

        this.service.withdrawChips(profile.getUsername(), withdrawal.amount);
    }
}
